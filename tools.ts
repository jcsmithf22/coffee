...
const getAddress = tool({
  ...
  async run(input) {
    const address = await client.address.get(input.addressId);
    return address.data;
  },
});
...
const createAddress = tool({
  ...
  async run(input) {
    const address = await client.address.create(input);
    return address.data;
  },
});
...
const addCartItem = tool({
  ...
  async run(input) {
    const response = await client.cart.setItem(input);
    return response.data;
  },
});
...
const setCartAddress = tool({
  ...
  async run(input) {
    const response = await client.cart.setAddress(input);
    return response.data;
  },
});
...
const setCartCard = tool({
  ...
  async run(input) {
    const response = await client.cart.setCard(input);
    return response.data;
  },
});
...
const _createOrder = tool({
  ...
  async run(input) {
    const order = await client.order.create(input);
    return order.data;
  },
});
...
const createSubscription = tool({
  ...
  async run(input) {
    const subscription = await client.subscription.create(input);
    return subscription.data;
  },
});
...
const subscribeEmail = tool({
  ...
  async run(input) {
    const email = await client.email.create(input);
    return email.data;
  },
});
